...
ggsave(
    ...
    device = "png", width = 7, height = 3, dpi = 600, bg = "white",# compression = "lzw"
)
toc() #5.1s
...
ggsave(
    ...
    filename = "just_biodiversity.tiff", path = "figures/", 
    device = "tiff", width = 6, height = 5, dpi = 600, bg = "white", compression = "lzw")
toc() #24s
